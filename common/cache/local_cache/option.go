...
// SetInternal 设置间隔时间
func SetInternal(interval time.Duration) Option {
...
func SetDefaultExpire(expire time.Duration) Option {
	return func(c interface{}) {
...
func SetCapture(capture func(k string, v interface{})) Option {
	return func(c interface{}) {
